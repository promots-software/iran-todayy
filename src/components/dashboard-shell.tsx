...
const routes=[['/','نظرة عامة'],['/sources','المصادر'],['/approvals','الموافقات'],['/review','المراجعات'],['/published','الأخبار المنشورة'],['/filtered','المستبعد والمرفوض'],['/events','الأخبار المكررة'],['/logs','سجل العمليات'],['/settings','الإعدادات'],['/system','حالة النظام'],['/operations','مركز العمليات']];
