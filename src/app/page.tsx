...
export default async function OverviewPage() {
  ...
  return <><PageTitle title="نظرة عامة" description="تابع الأخبار، راجع الصياغة، وأشرف على النشر من مكان واحد." />
    <div className="notice foundation"><strong>غرفة الأخبار قيد التأسيس</strong><span>إدارة المصادر والإعدادات متاحة. استقبال الأخبار والتحرير والنشر لم تُفعّل بعد.</span><Link href="/system">حالة النظام ←</Link></div>
