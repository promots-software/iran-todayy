...
export default async function SystemPage() {
  ...
  return <><PageTitle title="حالة النظام" description="اتصال قاعدة البيانات وآخر نبضة للعامل وحالة مهام المعالجة." />{!result.available && <DatabaseNotice />}
    <section className="panel"><h2>الخدمات</h2><dl className="facts"><dt>قاعدة البيانات</dt><dd>{result.available ? "متصلة" : "غير متاحة"}</dd><dt>مراقبة Telegram وX</dt><dd>موصلات معزولة؛ الوصول الحي غير مهيأ</dd><dt>محرك التحرير</dt><dd>قواعد موثقة واختبارات جاهزة؛ مزود الفهم الحي غير مهيأ</dd><dt>النشر إلى Telegram</dt><dd>غير منفّذ — المرحلة الثالثة</dd></dl></section>
