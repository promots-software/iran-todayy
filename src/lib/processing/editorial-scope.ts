...
export const coverageInstructions='Coverage includes Iran, Syria, Lebanon, Palestine, Iraq and Yemen equally. POLITICAL_NEWS is a legacy enum meaning any genuine news: politics, local news, health, economy, science, culture, sports, weather and other news. Never reject news for being non-political or not mentioning Iran. SPORT and ENTERTAINMENT are not rejection reasons for genuine news. Geography is only coverage metadata; never infer identities, roles, affiliations or relationships from it. Unknown topic remains UNKNOWN. Evidence, attribution and completeness requirements are unchanged.';
